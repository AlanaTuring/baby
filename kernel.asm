...
801003b0:	e8 fb 02 00 00       	call   801006b0 <cprintf>
  cprintf("\n");
801003b5:	c7 04 24 8f 76 10 80 	movl   $0x8010768f,(%esp)
...
8010041f:	e8 0c 59 00 00       	call   80105d30 <uartputc>
...
801004ea:	e8 41 58 00 00       	call   80105d30 <uartputc>
801004ef:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
801004f6:	e8 35 58 00 00       	call   80105d30 <uartputc>
801004fb:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
80100502:	e8 29 58 00 00       	call   80105d30 <uartputc>
...
8010064b:	0f b6 92 e0 76 10 80 	movzbl -0x7fef8920(%edx),%edx
...
80100838:	b9 28 00 00 00       	mov    $0x28,%ecx
        s = "(null)";
8010083d:	bf 38 72 10 80       	mov    $0x80107238,%edi
...
8010088c:	68 3f 72 10 80       	push   $0x8010723f
...
80100a66:	68 48 72 10 80       	push   $0x80107248
...
80100b14:	0f 85 f1 00 00 00    	jne    80100c0b <exec+0x15b>
  ...
  if((pgdir = setupkvm()) == 0)
80100b1a:	e8 81 63 00 00       	call   80106ea0 <setupkvm>
...
80100b8b:	e8 40 61 00 00       	call   80106cd0 <allocuvm>
...
80100bc1:	e8 3a 60 00 00       	call   80106c00 <loaduvm>
...
80100c03:	e8 18 62 00 00       	call   80106e20 <freevm>
  if(ip){
...
80100c62:	e8 69 60 00 00       	call   80106cd0 <allocuvm>
...
80100c81:	31 f6                	xor    %esi,%esi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 b8 62 00 00       	call   80106f40 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100cee:	e8 1d 64 00 00       	call   80107110 <copyout>
...
80100d03:	e8 18 61 00 00       	call   80106e20 <freevm>
...
80100d5f:	e8 ac 63 00 00       	call   80107110 <copyout>
...
80100dcb:	e8 a0 5c 00 00       	call   80106a70 <switchuvm>
  freevm(oldpgdir);
80100dd0:	89 34 24             	mov    %esi,(%esp)
80100dd3:	e8 48 60 00 00       	call   80106e20 <freevm>
  return 0;
...
80100e1a:	68 50 72 10 80       	push   $0x80107250
...
80100e36:	68 5c 72 10 80       	push   $0x8010725c
...
80100efb:	68 63 72 10 80       	push   $0x80107263
...
80100fdc:	68 6b 72 10 80       	push   $0x8010726b
...
801010c2:	68 75 72 10 80       	push   $0x80107275
...
80101197:	68 7e 72 10 80       	push   $0x8010727e
...
801011d1:	68 84 72 10 80       	push   $0x80107284
...
80101289:	68 8e 72 10 80       	push   $0x8010728e
...
80101377:	e8 34 32 00 00       	call   801045b0 <release>
...
801013a5:	e8 06 32 00 00       	call   801045b0 <release>
      return ip;
...
801013d8:	68 a4 72 10 80       	push   $0x801072a4
...
80101457:	68 b4 72 10 80       	push   $0x801072b4
...
80101535:	68 c7 72 10 80       	push   $0x801072c7
...
80101561:	e8 3a 32 00 00       	call   801047a0 <memmove>
  brelse(bp);
...
8010158c:	68 da 72 10 80       	push   $0x801072da
80101591:	68 60 f9 10 80       	push   $0x8010f960
80101596:	e8 85 2e 00 00       	call   80104420 <initlock>
  for(i = 0; i < NINODE; i++) {
8010159b:	83 c4 10             	add    $0x10,%esp
8010159e:	66 90                	xchg   %ax,%ax
    initsleeplock(&icache.inode[i].lock, "inode");
801015a0:	83 ec 08             	sub    $0x8,%esp
801015a3:	68 e1 72 10 80       	push   $0x801072e1
801015a8:	53                   	push   %ebx
  for(i = 0; i < NINODE; i++) {
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 3c 2d 00 00       	call   801042f0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 bf 31 00 00       	call   801047a0 <memmove>
  brelse(bp);
...
80101613:	68 f4 76 10 80       	push   $0x801076f4
...
801016e3:	68 e7 72 10 80       	push   $0x801072e7
...
80101751:	e8 4a 30 00 00       	call   801047a0 <memmove>
  log_write(bp);
...
8010177f:	e8 8c 2e 00 00       	call   80104610 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010178f:	e8 1c 2e 00 00       	call   801045b0 <release>
}
...
801017c2:	e8 69 2b 00 00       	call   80104330 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 63 2f 00 00       	call   801047a0 <memmove>
    brelse(bp);
...
8010185d:	68 ff 72 10 80       	push   $0x801072ff
80101862:	e8 19 eb ff ff       	call   80100380 <panic>
    panic("ilock");
80101867:	83 ec 0c             	sub    $0xc,%esp
8010186a:	68 f9 72 10 80       	push   $0x801072f9
...
80101893:	e8 38 2b 00 00       	call   801043d0 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 dc 2a 00 00       	jmp    80104390 <releasesleep>
    panic("iunlock");
801018b4:	83 ec 0c             	sub    $0xc,%esp
801018b7:	68 0e 73 10 80       	push   $0x8010730e
...
801018e0:	e8 4b 2a 00 00       	call   80104330 <acquiresleep>
...
801018fa:	e8 91 2a 00 00       	call   80104390 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101906:	e8 05 2d 00 00       	call   80104610 <acquire>
  ip->ref--;
...
80101a43:	e8 88 29 00 00       	call   801043d0 <holdingsleep>
...
80101a5a:	e8 31 29 00 00       	call   80104390 <releasesleep>
  iput(ip);
...
80101a73:	68 0e 73 10 80       	push   $0x8010730e
...
80101b57:	e8 44 2c 00 00       	call   801047a0 <memmove>
    brelse(bp);
...
80101c55:	e8 46 2b 00 00       	call   801047a0 <memmove>
    log_write(bp);
...
80101d82:	68 28 73 10 80       	push   $0x80107328
80101d87:	e8 f4 e5 ff ff       	call   80100380 <panic>
    panic("dirlookup not DIR");
80101d8c:	83 ec 0c             	sub    $0xc,%esp
80101d8f:	68 16 73 10 80       	push   $0x80107316
...
80101dca:	e8 41 28 00 00       	call   80104610 <acquire>
  ip->ref++;
80101dcf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dd3:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101dda:	e8 d1 27 00 00       	call   801045b0 <release>
...
80101e9c:	e8 2f 25 00 00       	call   801043d0 <holdingsleep>
...
80101ebe:	e8 cd 24 00 00       	call   80104390 <releasesleep>
  iput(ip);
...
80101f25:	e8 a6 24 00 00       	call   801043d0 <holdingsleep>
...
80101f3c:	e8 4f 24 00 00       	call   80104390 <releasesleep>
  iput(ip);
...
80101f75:	e8 56 24 00 00       	call   801043d0 <holdingsleep>
...
80101f8c:	e8 ff 23 00 00       	call   80104390 <releasesleep>
}
...
80101fb1:	68 0e 73 10 80       	push   $0x8010730e
...
8010201d:	e8 3e 28 00 00       	call   80104860 <strncpy>
  de.inum = inum;
...
8010205b:	68 37 73 10 80       	push   $0x80107337
80102060:	e8 1b e3 ff ff       	call   80100380 <panic>
    panic("dirlink");
80102065:	83 ec 0c             	sub    $0xc,%esp
80102068:	68 93 75 10 80       	push   $0x80107593
...
8010217b:	68 4d 73 10 80       	push   $0x8010734d
80102180:	e8 fb e1 ff ff       	call   80100380 <panic>
    panic("idestart");
80102185:	83 ec 0c             	sub    $0xc,%esp
80102188:	68 44 73 10 80       	push   $0x80107344
...
801021a6:	68 5f 73 10 80       	push   $0x8010735f
801021ab:	68 00 16 11 80       	push   $0x80111600
801021b0:	e8 6b 22 00 00       	call   80104420 <initlock>
...
8010223e:	e8 cd 23 00 00       	call   80104610 <acquire>
...
801022bb:	e8 f0 22 00 00       	call   801045b0 <release>
...
801022de:	e8 ed 20 00 00       	call   801043d0 <holdingsleep>
...
80102318:	e8 f3 22 00 00       	call   80104610 <acquire>
...
80102375:	c9                   	leave
  release(&idelock);
80102376:	e9 35 22 00 00       	jmp    801045b0 <release>
...
8010240a:	68 48 77 10 80       	push   $0x80107748
...
801024d2:	e8 39 22 00 00       	call   80104710 <memset>
...
80102508:	e8 03 21 00 00       	call   80104610 <acquire>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 88 20 00 00       	jmp    801045b0 <release>
    panic("kfree");
80102528:	83 ec 0c             	sub    $0xc,%esp
8010252b:	68 ac 73 10 80       	push   $0x801073ac
...
801025fb:	68 b2 73 10 80       	push   $0x801073b2
80102600:	68 40 16 11 80       	push   $0x80111640
80102605:	e8 16 1e 00 00       	call   80104420 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 73 1f 00 00       	call   80104610 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 e8 1e 00 00       	call   801045b0 <release>
}
...
80102ad3:	e8 78 1c 00 00       	call   80104750 <memcmp>
...
80102c04:	e8 97 1b 00 00       	call   801047a0 <memmove>
...
80102caa:	68 b7 73 10 80       	push   $0x801073b7
80102caf:	68 a0 16 11 80       	push   $0x801116a0
80102cb4:	e8 67 17 00 00       	call   80104420 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 c0 18 00 00       	call   80104610 <acquire>
...
80102d9c:	e8 0f 18 00 00       	call   801045b0 <release>
      break;
    }
  }
}
...
80102dfc:	e8 af 17 00 00       	call   801045b0 <release>
}
...
80102e16:	e8 f5 17 00 00       	call   80104610 <acquire>
    log.committing = 0;
...
80102e38:	e8 73 17 00 00       	call   801045b0 <release>
...
80102e94:	e8 07 19 00 00       	call   801047a0 <memmove>
...
80102ef4:	e8 b7 16 00 00       	call   801045b0 <release>
...
80102f07:	68 bb 73 10 80       	push   $0x801073bb
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 12 16 00 00       	jmp    801045b0 <release>
...
80102fb5:	68 ca 73 10 80       	push   $0x801073ca
80102fba:	e8 c1 d3 ff ff       	call   80100380 <panic>
    panic("log_write outside of trans");
80102fbf:	83 ec 0c             	sub    $0xc,%esp
80102fc2:	68 e0 73 10 80       	push   $0x801073e0
...
80102fe8:	68 fb 73 10 80       	push   $0x801073fb
80102fed:	e8 be d6 ff ff       	call   801006b0 <cprintf>
  idtinit();       // load idt register
80102ff2:	e8 69 29 00 00       	call   80105960 <idtinit>
...
80103013:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103016:	e8 45 3a 00 00       	call   80106a60 <switchkvm>
  seginit();
8010301b:	e8 b0 39 00 00       	call   801069d0 <seginit>
  lapicinit();
...
80103074:	e8 c7 2b 00 00       	call   80105c40 <uartinit>
  pinit();         // process table
80103079:	e8 42 08 00 00       	call   801038c0 <pinit>
  tvinit();        // trap vectors
8010307e:	e8 5d 28 00 00       	call   801058e0 <tvinit>
  binit();         // buffer cache
...
801030a4:	e8 f7 16 00 00       	call   801047a0 <memmove>
...
8010318e:	68 0f 74 10 80       	push   $0x8010740f
80103193:	56                   	push   %esi
80103194:	e8 b7 15 00 00       	call   80104750 <memcmp>
...
80103249:	68 14 74 10 80       	push   $0x80107414
8010324e:	50                   	push   %eax
8010324f:	e8 fc 14 00 00       	call   80104750 <memcmp>
...
8010337b:	68 19 74 10 80       	push   $0x80107419
...
801033a2:	68 0f 74 10 80       	push   $0x8010740f
801033a7:	53                   	push   %ebx
801033a8:	e8 a3 13 00 00       	call   80104750 <memcmp>
...
801033d8:	68 7c 77 10 80       	push   $0x8010777c
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 31 74 10 80       	push   $0x80107431
80103488:	50                   	push   %eax
80103489:	e8 92 0f 00 00       	call   80104420 <initlock>
  (*f0)->type = FD_PIPE;
...
8010350f:	e8 fc 10 00 00       	call   80104610 <acquire>
  if(writable){
...
80103553:	5d                   	pop    %ebp
    release(&p->lock);
80103554:	e9 57 10 00 00       	jmp    801045b0 <release>
80103559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103560:	83 ec 0c             	sub    $0xc,%esp
80103563:	53                   	push   %ebx
80103564:	e8 47 10 00 00       	call   801045b0 <release>
    kfree((char*)p);
...
801035b0:	e8 5b 10 00 00       	call   80104610 <acquire>
  for(i = 0; i < n; i++){
...
80103644:	e8 67 0f 00 00       	call   801045b0 <release>
        return -1;
...
801036a0:	e8 0b 0f 00 00       	call   801045b0 <release>
  return n;
...
801036d6:	e8 35 0f 00 00       	call   80104610 <acquire>
...
8010376e:	e8 3d 0e 00 00       	call   801045b0 <release>
  return i;
...
80103789:	e8 22 0e 00 00       	call   801045b0 <release>
      return -1;
...
801037ec:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037f2:	e8 b9 0d 00 00       	call   801045b0 <release>
...
80103814:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103817:	c7 40 14 d2 58 10 80 	movl   $0x801058d2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103826:	e8 e5 0e 00 00       	call   80104710 <memset>
...
8010384a:	e8 61 0d 00 00       	call   801045b0 <release>
  return 0;
...
8010387b:	e8 30 0d 00 00       	call   801045b0 <release>
...
801038c6:	68 36 74 10 80       	push   $0x80107436
801038cb:	68 20 1d 11 80       	push   $0x80111d20
801038d0:	e8 4b 0b 00 00       	call   80104420 <initlock>
}
...
80103964:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103967:	e8 54 0b 00 00       	call   801044c0 <pushcli>
  c = mycpu();
8010396c:	e8 6f ff ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103971:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103977:	e8 94 0b 00 00       	call   80104510 <popcli>
}
...
801039a3:	e8 f8 34 00 00       	call   80106ea0 <setupkvm>
...
801039c1:	e8 ba 31 00 00       	call   80106b80 <inituvm>
...
801039d6:	e8 35 0d 00 00       	call   80104710 <memset>
...
80103a2f:	68 66 74 10 80       	push   $0x80107466
80103a34:	50                   	push   %eax
80103a35:	e8 86 0e 00 00       	call   801048c0 <safestrcpy>
  p->cwd = namei("/");
80103a3a:	c7 04 24 6f 74 10 80 	movl   $0x8010746f,(%esp)
...
80103a63:	e8 48 0b 00 00       	call   801045b0 <release>
}
...
80103a73:	68 4d 74 10 80       	push   $0x8010744d
...
80103a85:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a88:	e8 33 0a 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103a8d:	e8 4e fe ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103a92:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103a98:	e8 73 0a 00 00       	call   80104510 <popcli>
  sz = curproc->sz;
...
80103aab:	e8 c0 2f 00 00       	call   80106a70 <switchuvm>
  return 0;
...
80103aca:	e8 01 32 00 00       	call   80106cd0 <allocuvm>
...
80103aea:	e8 01 33 00 00       	call   80106df0 <deallocuvm>
...
80103b06:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b09:	e8 b2 09 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103b0e:	e8 cd fd ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103b13:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b19:	e8 f2 09 00 00       	call   80104510 <popcli>
  if((np = allocproc()) == 0){
...
80103b38:	e8 53 34 00 00       	call   80106f90 <copyuvm>
...
80103bb1:	e8 0a 0d 00 00       	call   801048c0 <safestrcpy>
  pid = np->pid;
...
80103bd3:	e8 d8 09 00 00       	call   801045b0 <release>
  return pid;
...
80103c3e:	e8 cd 09 00 00       	call   80104610 <acquire>
...
80103c60:	e8 0b 2e 00 00       	call   80106a70 <switchuvm>
...
80103c6b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c72:	e8 a4 0c 00 00       	call   8010491b <swtch>
      switchkvm();
80103c77:	e8 e4 2d 00 00       	call   80106a60 <switchkvm>
      c->proc = 0;
...
80103cd2:	e8 99 08 00 00       	call   80104570 <holding>
...
80103d13:	e8 03 0c 00 00       	call   8010491b <swtch>
  mycpu()->intena = intena;
...
80103dda:	e8 31 08 00 00       	call   80104610 <acquire>
...
80103e7d:	68 be 74 10 80       	push   $0x801074be
80103e82:	e8 f9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103e87:	83 ec 0c             	sub    $0xc,%esp
80103e8a:	68 b1 74 10 80       	push   $0x801074b1
...
80103ea4:	53                   	push   %ebx
  pushcli();
80103ea5:	e8 16 06 00 00       	call   801044c0 <pushcli>
  c = mycpu();
...
80103ec2:	e8 49 07 00 00       	call   80104610 <acquire>
...
80103f0b:	0f 85 95 00 00 00    	jne    80103fa6 <wait+0x106>
  pushcli();
80103f11:	e8 aa 05 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103f16:	e8 c5 f9 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103f1b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f21:	e8 ea 05 00 00       	call   80104510 <popcli>
  if(p == 0)
...
80103f69:	e8 b2 2e 00 00       	call   80106e20 <freevm>
        p->pid = 0;
...
80103f95:	e8 16 06 00 00       	call   801045b0 <release>
        return pid;
...
80103fdc:	e8 2f 06 00 00       	call   80104610 <acquire>
  pushcli();
80103fe1:	e8 da 04 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80103fe6:	e8 f5 f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80103feb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ff1:	e8 1a 05 00 00       	call   80104510 <popcli>
...
80104009:	e8 a2 05 00 00       	call   801045b0 <release>
}
...
8010402c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010402f:	e8 8c 04 00 00       	call   801044c0 <pushcli>
  c = mycpu();
80104034:	e8 a7 f8 ff ff       	call   801038e0 <mycpu>
  p = c->proc;
80104039:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010403f:	e8 cc 04 00 00       	call   80104510 <popcli>
  if(p == 0)
...
80104060:	e8 ab 05 00 00       	call   80104610 <acquire>
    release(lk);
80104065:	89 34 24             	mov    %esi,(%esp)
80104068:	e8 43 05 00 00       	call   801045b0 <release>
  p->chan = chan;
...
8010408a:	e8 21 05 00 00       	call   801045b0 <release>
    acquire(lk);
...
8010409b:	5d                   	pop    %ebp
    acquire(lk);
8010409c:	e9 6f 05 00 00       	jmp    80104610 <acquire>
...
801040c9:	68 d0 74 10 80       	push   $0x801074d0
801040ce:	e8 ad c2 ff ff       	call   80100380 <panic>
    panic("sleep");
801040d3:	83 ec 0c             	sub    $0xc,%esp
801040d6:	68 ca 74 10 80       	push   $0x801074ca
...
801040ef:	e8 1c 05 00 00       	call   80104610 <acquire>
...
80104130:	c9                   	leave
  release(&ptable.lock);
80104131:	e9 7a 04 00 00       	jmp    801045b0 <release>
...
8010414f:	e8 bc 04 00 00       	call   80104610 <acquire>
...
8010418b:	e8 20 04 00 00       	call   801045b0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041a8:	e8 03 04 00 00       	call   801045b0 <release>
}
...
801041c3:	56                   	push   %esi
    struct proc *p;
int i = 1;
801041c4:	be 01 00 00 00       	mov    $0x1,%esi
void proc_list(void) {
801041c9:	53                   	push   %ebx
801041ca:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
    acquire(&ptable.lock);  
801041cf:	83 ec 0c             	sub    $0xc,%esp
801041d2:	68 20 1d 11 80       	push   $0x80111d20
801041d7:	e8 34 04 00 00       	call   80104610 <acquire>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
...
801041e5:	74 1c                	je     80104203 <proc_list+0x43>
            continue;
        cprintf("%d)  Name: %s  PID: %d, State: %d  Size: %d Bytes\n",i, p->name, p->pid, p->state, p->sz);
801041e7:	83 ec 08             	sub    $0x8,%esp
801041ea:	ff 73 94             	push   -0x6c(%ebx)
801041ed:	50                   	push   %eax
801041ee:	ff 73 a4             	push   -0x5c(%ebx)
801041f1:	53                   	push   %ebx
801041f2:	56                   	push   %esi
        i++;
801041f3:	83 c6 01             	add    $0x1,%esi
        cprintf("%d)  Name: %s  PID: %d, State: %d  Size: %d Bytes\n",i, p->name, p->pid, p->state, p->sz);
801041f6:	68 c4 77 10 80       	push   $0x801077c4
801041fb:	e8 b0 c4 ff ff       	call   801006b0 <cprintf>
        i++;
80104200:	83 c4 20             	add    $0x20,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++) {
80104203:	83 c3 7c             	add    $0x7c,%ebx
80104206:	81 fb c0 3c 11 80    	cmp    $0x80113cc0,%ebx
8010420c:	75 d2                	jne    801041e0 <proc_list+0x20>
    }
    release(&ptable.lock);
8010420e:	83 ec 0c             	sub    $0xc,%esp
80104211:	68 20 1d 11 80       	push   $0x80111d20
80104216:	e8 95 03 00 00       	call   801045b0 <release>
}
...
80104223:	5d                   	pop    %ebp
80104224:	c3                   	ret
80104225:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010422c:	00 
...
80104239:	bb c0 1d 11 80       	mov    $0x80111dc0,%ebx
...
8010426c:	74 ea                	je     80104258 <procdump+0x28>
      state = "???";
8010426e:	ba e1 74 10 80       	mov    $0x801074e1,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104273:	83 f8 05             	cmp    $0x5,%eax
80104276:	77 11                	ja     80104289 <procdump+0x59>
80104278:	8b 14 85 e0 7a 10 80 	mov    -0x7fef8520(,%eax,4),%edx
      state = "???";
8010427f:	b8 e1 74 10 80       	mov    $0x801074e1,%eax
...
8010428e:	68 e5 74 10 80       	push   $0x801074e5
...
801042cd:	68 21 72 10 80       	push   $0x80107221
...
801042fa:	68 18 75 10 80       	push   $0x80107518
...
80104355:	e8 c6 fc ff ff       	call   80104020 <sleep>
  while (lk->locked) {
...
80104363:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104369:	e8 f2 f5 ff ff       	call   80103960 <myproc>
...
801043b4:	e8 27 fd ff ff       	call   801040e0 <wakeup>
  release(&lk->lk);
...
8010440b:	e8 50 f5 ff ff       	call   80103960 <myproc>
...
80104555:	68 23 75 10 80       	push   $0x80107523
8010455a:	e8 21 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010455f:	83 ec 0c             	sub    $0xc,%esp
80104562:	68 3a 75 10 80       	push   $0x8010753a
...
80104593:	e8 48 f3 ff ff       	call   801038e0 <mycpu>
...
801046e3:	e8 f8 f1 ff ff       	call   801038e0 <mycpu>
...
801046f8:	68 49 75 10 80       	push   $0x80107549
...
80104937:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010493a:	e8 21 f0 ff ff       	call   80103960 <myproc>
...
801049c5:	e8 96 ef ff ff       	call   80103960 <myproc>
...
801049d3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049d6:	e8 85 ef ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a1e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a20:	e8 3b ef ff ff       	call   80103960 <myproc>
...
80104a2e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a31:	e8 2a ef ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a84:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a85:	e8 d6 ee ff ff       	call   80103960 <myproc>
...
80104a93:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a96:	e8 c5 ee ff ff       	call   80103960 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104aab:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104aae:	e8 ad ee ff ff       	call   80103960 <myproc>
  if(addr >= curproc->sz)
...
80104b04:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b07:	e8 54 ee ff ff       	call   80103960 <myproc>
...
80104b17:	83 fa 15             	cmp    $0x15,%edx
80104b1a:	77 24                	ja     80104b40 <syscall+0x40>
80104b1c:	8b 14 85 00 7b 10 80 	mov    -0x7fef8500(,%eax,4),%edx
...
80104b48:	68 51 75 10 80       	push   $0x80107551
...
80104b8a:	e8 11 d5 ff ff       	call   801020a0 <nameiparent>
...
80104b9c:	e8 ff cb ff ff       	call   801017a0 <ilock>
...
80104ba8:	e8 43 d1 ff ff       	call   80101cf0 <dirlookup>
...
80104bba:	e8 71 ce ff ff       	call   80101a30 <iunlockput>
    ilock(ip);
80104bbf:	89 34 24             	mov    %esi,(%esp)
80104bc2:	e8 d9 cb ff ff       	call   801017a0 <ilock>
...
80104bec:	e8 3f ce ff ff       	call   80101a30 <iunlockput>
    return 0;
...
80104c0a:	e8 21 ca ff ff       	call   80101630 <ialloc>
...
80104c20:	e8 7b cb ff ff       	call   801017a0 <ilock>
  ip->major = major;
...
80104c41:	e8 aa ca ff ff       	call   801016f0 <iupdate>
...
80104c58:	e8 63 d3 ff ff       	call   80101fc0 <dirlink>
...
80104c68:	e8 c3 cd ff ff       	call   80101a30 <iunlockput>
  return ip;
...
80104c89:	e8 62 ca ff ff       	call   801016f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c8e:	83 c4 0c             	add    $0xc,%esp
80104c91:	ff 76 04             	push   0x4(%esi)
80104c94:	68 89 75 10 80       	push   $0x80107589
80104c99:	56                   	push   %esi
80104c9a:	e8 21 d3 ff ff       	call   80101fc0 <dirlink>
...
80104cac:	68 88 75 10 80       	push   $0x80107588
80104cb1:	56                   	push   %esi
80104cb2:	e8 09 d3 ff ff       	call   80101fc0 <dirlink>
...
80104d10:	e8 4b ec ff ff       	call   80103960 <myproc>
...
80104d90:	e8 cb eb ff ff       	call   80103960 <myproc>
...
80104e10:	e8 4b eb ff ff       	call   80103960 <myproc>
...
80104ea1:	74 25                	je     80104ec8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104ea3:	e8 b8 ea ff ff       	call   80103960 <myproc>
  fileclose(f);
...
80104ef0:	e8 6b ea ff ff       	call   80103960 <myproc>
...
80104f72:	0f 88 e2 00 00 00    	js     8010505a <sys_link+0x11a>
  begin_op();
80104f78:	e8 c3 dd ff ff       	call   80102d40 <begin_op>
  if((ip = namei(old)) == 0){
80104f7d:	83 ec 0c             	sub    $0xc,%esp
80104f80:	ff 75 d4             	push   -0x2c(%ebp)
80104f83:	e8 f8 d0 ff ff       	call   80102080 <namei>
...
80104f99:	e8 02 c8 ff ff       	call   801017a0 <ilock>
  if(ip->type == T_DIR){
...
80104fb8:	e8 33 c7 ff ff       	call   801016f0 <iupdate>
  iunlock(ip);
80104fbd:	89 1c 24             	mov    %ebx,(%esp)
80104fc0:	e8 bb c8 ff ff       	call   80101880 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104fc5:	58                   	pop    %eax
80104fc6:	5a                   	pop    %edx
80104fc7:	57                   	push   %edi
80104fc8:	ff 75 d0             	push   -0x30(%ebp)
80104fcb:	e8 d0 d0 ff ff       	call   801020a0 <nameiparent>
...
80104fdd:	e8 be c7 ff ff       	call   801017a0 <ilock>
...
80104ff3:	e8 c8 cf ff ff       	call   80101fc0 <dirlink>
...
80105003:	e8 28 ca ff ff       	call   80101a30 <iunlockput>
  iput(ip);
80105008:	89 1c 24             	mov    %ebx,(%esp)
8010500b:	e8 c0 c8 ff ff       	call   801018d0 <iput>
  end_op();
80105010:	e8 9b dd ff ff       	call   80102db0 <end_op>
  return 0;
...
8010502c:	e8 ff c9 ff ff       	call   80101a30 <iunlockput>
    goto bad;
80105031:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105034:	83 ec 0c             	sub    $0xc,%esp
80105037:	53                   	push   %ebx
80105038:	e8 63 c7 ff ff       	call   801017a0 <ilock>
  ip->nlink--;
8010503d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105042:	89 1c 24             	mov    %ebx,(%esp)
80105045:	e8 a6 c6 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
8010504a:	89 1c 24             	mov    %ebx,(%esp)
8010504d:	e8 de c9 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105052:	e8 59 dd ff ff       	call   80102db0 <end_op>
  return -1;
...
80105065:	e8 c6 c9 ff ff       	call   80101a30 <iunlockput>
    end_op();
8010506a:	e8 41 dd ff ff       	call   80102db0 <end_op>
    return -1;
8010506f:	83 c4 10             	add    $0x10,%esp
80105072:	eb e6                	jmp    8010505a <sys_link+0x11a>
    end_op();
80105074:	e8 37 dd ff ff       	call   80102db0 <end_op>
    return -1;
...
801050c8:	e8 d3 c6 ff ff       	call   801017a0 <ilock>
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
801050cd:	58                   	pop    %eax
801050ce:	5a                   	pop    %edx
801050cf:	68 89 75 10 80       	push   $0x80107589
801050d4:	53                   	push   %ebx
801050d5:	e8 f6 cb ff ff       	call   80101cd0 <namecmp>
...
801050e8:	68 88 75 10 80       	push   $0x80107588
801050ed:	53                   	push   %ebx
801050ee:	e8 dd cb ff ff       	call   80101cd0 <namecmp>
...
80105107:	e8 e4 cb ff ff       	call   80101cf0 <dirlookup>
...
8010511d:	e8 7e c6 ff ff       	call   801017a0 <ilock>
  if(ip->nlink < 1)
...
80105150:	e8 5b ca ff ff       	call   80101bb0 <writei>
...
80105172:	e8 b9 c8 ff ff       	call   80101a30 <iunlockput>
  ip->nlink--;
80105177:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010517c:	89 1c 24             	mov    %ebx,(%esp)
8010517f:	e8 6c c5 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
80105184:	89 1c 24             	mov    %ebx,(%esp)
80105187:	e8 a4 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010518c:	e8 1f dc ff ff       	call   80102db0 <end_op>
  return 0;
...
801051bd:	e8 ee c8 ff ff       	call   80101ab0 <readi>
...
801051d5:	e8 56 c8 ff ff       	call   80101a30 <iunlockput>
    goto bad;
...
801051e6:	e8 45 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
801051eb:	e8 c0 db ff ff       	call   80102db0 <end_op>
  return -1;
...
80105282:	78 79                	js     801052fd <sys_open+0xad>
  ...
  begin_op();
80105284:	e8 b7 da ff ff       	call   80102d40 <begin_op>
...
80105295:	e8 e6 cd ff ff       	call   80102080 <namei>
...
801052ab:	e8 f0 c4 ff ff       	call   801017a0 <ilock>
...
801052f0:	e8 3b c7 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
80105323:	75 99                	jne    801052be <sys_open+0x6e>
      end_op();
80105325:	e8 86 da ff ff       	call   80102db0 <end_op>
      return -1;
...
80105338:	e8 43 c5 ff ff       	call   80101880 <iunlock>
  end_op();
8010533d:	e8 6e da ff ff       	call   80102db0 <end_op>
...
801053cf:	e8 5c c6 ff ff       	call   80101a30 <iunlockput>
  end_op();
801053d4:	e8 d7 d9 ff ff       	call   80102db0 <end_op>
  return 0;
...
801053df:	c3                   	ret
    end_op();
801053e0:	e8 cb d9 ff ff       	call   80102db0 <end_op>
    return -1;
...
801053f3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801053f6:	e8 45 d9 ff ff       	call   80102d40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010545e:	e8 cd c5 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105463:	e8 48 d9 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010546f:	90                   	nop
    end_op();
80105470:	e8 3b d9 ff ff       	call   80102db0 <end_op>
    return -1;
...
80105485:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105488:	e8 d3 e4 ff ff       	call   80103960 <myproc>
8010548d:	89 c6                	mov    %eax,%esi
  
  begin_op();
8010548f:	e8 ac d8 ff ff       	call   80102d40 <begin_op>
...
801054af:	e8 cc cb ff ff       	call   80102080 <namei>
...
801054c1:	e8 da c2 ff ff       	call   801017a0 <ilock>
  if(ip->type != T_DIR){
...
801054d4:	e8 a7 c3 ff ff       	call   80101880 <iunlock>
  iput(curproc->cwd);
801054d9:	58                   	pop    %eax
801054da:	ff 76 68             	push   0x68(%esi)
801054dd:	e8 ee c3 ff ff       	call   801018d0 <iput>
  end_op();
801054e2:	e8 c9 d8 ff ff       	call   80102db0 <end_op>
  curproc->cwd = ip;
...
80105504:	e8 27 c5 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
8010551f:	00 
    end_op();
80105520:	e8 8b d8 ff ff       	call   80102db0 <end_op>
    return -1;
...
8010564c:	e8 bf dd ff ff       	call   80103410 <pipealloc>
...
80105700 <sys_proc_list>:

#include <stddef.h>  



int sys_proc_list(void) {
80105700:	55                   	push   %ebp
80105701:	89 e5                	mov    %esp,%ebp
80105703:	83 ec 08             	sub    $0x8,%esp
    proc_list();
80105706:	e8 b5 ea ff ff       	call   801041c0 <proc_list>
    return 0;
}
...
{
  return fork();
80105710:	e9 eb e3 ff ff       	jmp    80103b00 <fork>
80105715:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010571c:	00 
...
80105723:	83 ec 08             	sub    $0x8,%esp
  exit();
80105726:	e8 45 e6 ff ff       	call   80103d70 <exit>
...
{
  return wait();
80105730:	e9 6b e7 ff ff       	jmp    80103ea0 <wait>
...
8010574c:	e8 6f f2 ff ff       	call   801049c0 <argint>
...
8010575e:	e8 dd e9 ff ff       	call   80104140 <kill>
...
80105783:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105786:	e8 d5 e1 ff ff       	call   80103960 <myproc>
...
801057ed:	e8 ce f1 ff ff       	call   801049c0 <argint>
...
80105801:	e8 0a ee ff ff       	call   80104610 <acquire>
  ticks0 = ticks;
...
8010582d:	e8 ee e7 ff ff       	call   80104020 <sleep>
  while(ticks - ticks0 < n){
...
80105865:	c9                   	leave
80105866:	c3                   	ret
80105867:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010586e:	00 
8010586f:	90                   	nop
  release(&tickslock);
...
801058e8:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801058ef:	00 
...
8010592e:	00 00 ef 
  initlock(&tickslock, "time");
80105931:	68 ce 75 10 80       	push   $0x801075ce
...
80105944:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
8010594a:	e8 d1 ea ff ff       	call   80104420 <initlock>
}
8010594f:	83 c4 10             	add    $0x10,%esp
80105952:	c9                   	leave
80105953:	c3                   	ret
80105954:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010595b:	00 
...
801059a2:	0f 84 58 01 00 00    	je     80105b00 <trap+0x170>
    if(myproc()->killed)
      exit();
    return;
  }
...
801059ae:	0f 87 7c 00 00 00    	ja     80105a30 <trap+0xa0>
801059b4:	ff 24 85 5c 7b 10 80 	jmp    *-0x7fef84a4(,%eax,4)
801059bb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059c0:	e8 6b c8 ff ff       	call   80102230 <ideintr>
    lapiceoi();
801059c5:	e8 26 cf ff ff       	call   801028f0 <lapiceoi>
  }
...
801059d1:	74 1a                	je     801059ed <trap+0x5d>
801059d3:	e8 88 df ff ff       	call   80103960 <myproc>
801059d8:	8b 50 24             	mov    0x24(%eax),%edx
801059db:	85 d2                	test   %edx,%edx
801059dd:	74 0e                	je     801059ed <trap+0x5d>
801059df:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059e3:	f7 d0                	not    %eax
801059e5:	a8 03                	test   $0x3,%al
801059e7:	0f 84 db 01 00 00    	je     80105bc8 <trap+0x238>
    exit();
...
801059f4:	74 0f                	je     80105a05 <trap+0x75>
801059f6:	e8 65 df ff ff       	call   80103960 <myproc>
801059fb:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801059ff:	0f 84 ab 00 00 00    	je     80105ab0 <trap+0x120>
     tf->trapno == T_IRQ0+IRQ_TIMER)
    yield();

  // Check if the process has been killed since we yielded
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a05:	e8 56 df ff ff       	call   80103960 <myproc>
80105a0a:	85 c0                	test   %eax,%eax
80105a0c:	74 1a                	je     80105a28 <trap+0x98>
80105a0e:	e8 4d df ff ff       	call   80103960 <myproc>
80105a13:	8b 40 24             	mov    0x24(%eax),%eax
80105a16:	85 c0                	test   %eax,%eax
80105a18:	74 0e                	je     80105a28 <trap+0x98>
80105a1a:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a1e:	f7 d0                	not    %eax
80105a20:	a8 03                	test   $0x3,%al
80105a22:	0f 84 05 01 00 00    	je     80105b2d <trap+0x19d>
    exit();
}
...
80105a35:	8b 7b 38             	mov    0x38(%ebx),%edi
80105a38:	85 c0                	test   %eax,%eax
80105a3a:	0f 84 a2 01 00 00    	je     80105be2 <trap+0x252>
80105a40:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a44:	0f 84 98 01 00 00    	je     80105be2 <trap+0x252>
...
80105a50:	e8 eb de ff ff       	call   80103940 <cpuid>
80105a55:	8b 73 30             	mov    0x30(%ebx),%esi
80105a58:	89 45 dc             	mov    %eax,-0x24(%ebp)
80105a5b:	8b 43 34             	mov    0x34(%ebx),%eax
...
80105a73:	8b 55 dc             	mov    -0x24(%ebp),%edx
80105a76:	52                   	push   %edx
80105a77:	ff 75 e4             	push   -0x1c(%ebp)
80105a7a:	56                   	push   %esi
            myproc()->pid, myproc()->name, tf->trapno,
80105a7b:	8b 75 e0             	mov    -0x20(%ebp),%esi
80105a7e:	83 c6 6c             	add    $0x6c,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80105a81:	56                   	push   %esi
80105a82:	ff 70 10             	push   0x10(%eax)
80105a85:	68 50 78 10 80       	push   $0x80107850
80105a8a:	e8 21 ac ff ff       	call   801006b0 <cprintf>
    myproc()->killed = 1;
80105a8f:	83 c4 20             	add    $0x20,%esp
80105a92:	e8 c9 de ff ff       	call   80103960 <myproc>
80105a97:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a9e:	e8 bd de ff ff       	call   80103960 <myproc>
80105aa3:	85 c0                	test   %eax,%eax
80105aa5:	0f 85 28 ff ff ff    	jne    801059d3 <trap+0x43>
80105aab:	e9 3d ff ff ff       	jmp    801059ed <trap+0x5d>
  if(myproc() && myproc()->state == RUNNING &&
80105ab0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ab4:	0f 85 4b ff ff ff    	jne    80105a05 <trap+0x75>
    yield();
80105aba:	e8 11 e5 ff ff       	call   80103fd0 <yield>
80105abf:	e9 41 ff ff ff       	jmp    80105a05 <trap+0x75>
80105ac4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
80105ac8:	8b 7b 38             	mov    0x38(%ebx),%edi
80105acb:	0f b7 73 3c          	movzwl 0x3c(%ebx),%esi
80105acf:	e8 6c de ff ff       	call   80103940 <cpuid>
80105ad4:	57                   	push   %edi
80105ad5:	56                   	push   %esi
80105ad6:	50                   	push   %eax
80105ad7:	68 f8 77 10 80       	push   $0x801077f8
80105adc:	e8 cf ab ff ff       	call   801006b0 <cprintf>
    lapiceoi();
80105ae1:	e8 0a ce ff ff       	call   801028f0 <lapiceoi>
    break;
80105ae6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ae9:	e8 72 de ff ff       	call   80103960 <myproc>
80105aee:	85 c0                	test   %eax,%eax
80105af0:	0f 85 dd fe ff ff    	jne    801059d3 <trap+0x43>
80105af6:	e9 f2 fe ff ff       	jmp    801059ed <trap+0x5d>
80105afb:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    if(myproc()->killed)
80105b00:	e8 5b de ff ff       	call   80103960 <myproc>
80105b05:	8b 70 24             	mov    0x24(%eax),%esi
80105b08:	85 f6                	test   %esi,%esi
80105b0a:	0f 85 c8 00 00 00    	jne    80105bd8 <trap+0x248>
    myproc()->tf = tf;
80105b10:	e8 4b de ff ff       	call   80103960 <myproc>
80105b15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b18:	e8 e3 ef ff ff       	call   80104b00 <syscall>
    if(myproc()->killed)
80105b1d:	e8 3e de ff ff       	call   80103960 <myproc>
80105b22:	8b 48 24             	mov    0x24(%eax),%ecx
80105b25:	85 c9                	test   %ecx,%ecx
80105b27:	0f 84 fb fe ff ff    	je     80105a28 <trap+0x98>
}
...
80105b33:	5d                   	pop    %ebp
      exit();
80105b34:	e9 37 e2 ff ff       	jmp    80103d70 <exit>
...
80105b51:	0f 85 7c fe ff ff    	jne    801059d3 <trap+0x43>
80105b57:	e9 91 fe ff ff       	jmp    801059ed <trap+0x5d>
80105b5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b60:	e8 5b cc ff ff       	call   801027c0 <kbdintr>
    lapiceoi();
80105b65:	e8 86 cd ff ff       	call   801028f0 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6a:	e8 f1 dd ff ff       	call   80103960 <myproc>
80105b6f:	85 c0                	test   %eax,%eax
80105b71:	0f 85 5c fe ff ff    	jne    801059d3 <trap+0x43>
80105b77:	e9 71 fe ff ff       	jmp    801059ed <trap+0x5d>
80105b7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105b80:	e8 bb dd ff ff       	call   80103940 <cpuid>
80105b85:	85 c0                	test   %eax,%eax
80105b87:	0f 85 38 fe ff ff    	jne    801059c5 <trap+0x35>
      acquire(&tickslock);
80105b8d:	83 ec 0c             	sub    $0xc,%esp
80105b90:	68 80 3c 11 80       	push   $0x80113c80
80105b95:	e8 76 ea ff ff       	call   80104610 <acquire>
      ticks++;
80105b9a:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105ba1:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
80105ba8:	e8 33 e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105bad:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105bb4:	e8 f7 e9 ff ff       	call   801045b0 <release>
80105bb9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105bbc:	e9 04 fe ff ff       	jmp    801059c5 <trap+0x35>
80105bc1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105bc8:	e8 a3 e1 ff ff       	call   80103d70 <exit>
80105bcd:	e9 1b fe ff ff       	jmp    801059ed <trap+0x5d>
80105bd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bd8:	e8 93 e1 ff ff       	call   80103d70 <exit>
80105bdd:	e9 2e ff ff ff       	jmp    80105b10 <trap+0x180>
80105be2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105be5:	e8 56 dd ff ff       	call   80103940 <cpuid>
80105bea:	83 ec 0c             	sub    $0xc,%esp
80105bed:	56                   	push   %esi
80105bee:	57                   	push   %edi
80105bef:	50                   	push   %eax
80105bf0:	ff 73 30             	push   0x30(%ebx)
80105bf3:	68 1c 78 10 80       	push   $0x8010781c
80105bf8:	e8 b3 aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105bfd:	83 c4 14             	add    $0x14,%esp
80105c00:	68 d3 75 10 80       	push   $0x801075d3
80105c05:	e8 76 a7 ff ff       	call   80100380 <panic>
...
{
  if(!uart)
80105c10:	a1 c0 44 11 80       	mov    0x801144c0,%eax
...
80105c97:	0f 84 7c 00 00 00    	je     80105d19 <uartinit+0xd9>
  uart = 1;
80105c9d:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105ca4:	00 00 00 
80105ca7:	89 fa                	mov    %edi,%edx
...
80105cb0:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105cb3:	bf d8 75 10 80       	mov    $0x801075d8,%edi
80105cb8:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105cbd:	6a 00                	push   $0x0
80105cbf:	6a 04                	push   $0x4
80105cc1:	e8 9a c7 ff ff       	call   80102460 <ioapicenable>
80105cc6:	83 c4 10             	add    $0x10,%esp
  for(p="xv6...\n"; *p; p++)
80105cc9:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
80105ccd:	8d 76 00             	lea    0x0(%esi),%esi
  if(!uart)
80105cd0:	a1 c0 44 11 80       	mov    0x801144c0,%eax
80105cd5:	85 c0                	test   %eax,%eax
80105cd7:	74 32                	je     80105d0b <uartinit+0xcb>
80105cd9:	89 f2                	mov    %esi,%edx
80105cdb:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105cdc:	a8 20                	test   $0x20,%al
80105cde:	75 21                	jne    80105d01 <uartinit+0xc1>
80105ce0:	bb 80 00 00 00       	mov    $0x80,%ebx
...
80105cf8:	74 07                	je     80105d01 <uartinit+0xc1>
80105cfa:	89 f2                	mov    %esi,%edx
80105cfc:	ec                   	in     (%dx),%al
80105cfd:	a8 20                	test   $0x20,%al
80105cff:	74 e7                	je     80105ce8 <uartinit+0xa8>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105d01:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d06:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105d0a:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105d0b:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105d0f:	83 c7 01             	add    $0x1,%edi
80105d12:	88 45 e7             	mov    %al,-0x19(%ebp)
80105d15:	84 c0                	test   %al,%al
80105d17:	75 b7                	jne    80105cd0 <uartinit+0x90>
}
...
80105d1f:	5d                   	pop    %ebp
80105d20:	c3                   	ret
80105d21:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80105d28:	00 
...
80105d37:	74 4f                	je     80105d88 <uartputc+0x58>
{
80105d39:	55                   	push   %ebp
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80105d3a:	ba fd 03 00 00       	mov    $0x3fd,%edx
80105d3f:	89 e5                	mov    %esp,%ebp
80105d41:	56                   	push   %esi
80105d42:	53                   	push   %ebx
80105d43:	ec                   	in     (%dx),%al
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105d44:	a8 20                	test   $0x20,%al
80105d46:	75 29                	jne    80105d71 <uartputc+0x41>
...
80105d5b:	6a 0a                	push   $0xa
80105d5d:	e8 ae cb ff ff       	call   80102910 <microdelay>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80105d62:	83 c4 10             	add    $0x10,%esp
80105d65:	83 eb 01             	sub    $0x1,%ebx
80105d68:	74 07                	je     80105d71 <uartputc+0x41>
80105d6a:	89 f2                	mov    %esi,%edx
80105d6c:	ec                   	in     (%dx),%al
80105d6d:	a8 20                	test   $0x20,%al
80105d6f:	74 e7                	je     80105d58 <uartputc+0x28>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105d71:	8b 45 08             	mov    0x8(%ebp),%eax
80105d74:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d79:	ee                   	out    %al,(%dx)
}
80105d7a:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105d7d:	5b                   	pop    %ebx
80105d7e:	5e                   	pop    %esi
80105d7f:	5d                   	pop    %ebp
80105d80:	c3                   	ret
...
80105d96:	68 10 5c 10 80       	push   $0x80105c10
80105d9b:	e8 00 ab ff ff       	call   801008a0 <consoleintr>
}
...
80106835:	39 d3                	cmp    %edx,%ebx
80106837:	73 56                	jae    8010688f <deallocuvm.part.0+0x6f>
80106839:	89 4d e0             	mov    %ecx,-0x20(%ebp)
8010683c:	89 c6                	mov    %eax,%esi
8010683e:	89 d7                	mov    %edx,%edi
80106840:	eb 12                	jmp    80106854 <deallocuvm.part.0+0x34>
80106842:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106848:	83 c2 01             	add    $0x1,%edx
8010684b:	89 d3                	mov    %edx,%ebx
8010684d:	c1 e3 16             	shl    $0x16,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106850:	39 fb                	cmp    %edi,%ebx
80106852:	73 38                	jae    8010688c <deallocuvm.part.0+0x6c>
  pde = &pgdir[PDX(va)];
80106854:	89 da                	mov    %ebx,%edx
80106856:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106859:	8b 04 96             	mov    (%esi,%edx,4),%eax
8010685c:	a8 01                	test   $0x1,%al
8010685e:	74 e8                	je     80106848 <deallocuvm.part.0+0x28>
  return &pgtab[PTX(va)];
80106860:	89 d9                	mov    %ebx,%ecx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106862:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  return &pgtab[PTX(va)];
80106867:	c1 e9 0a             	shr    $0xa,%ecx
8010686a:	81 e1 fc 0f 00 00    	and    $0xffc,%ecx
80106870:	8d 84 08 00 00 00 80 	lea    -0x80000000(%eax,%ecx,1),%eax
    if(!pte)
80106877:	85 c0                	test   %eax,%eax
80106879:	74 cd                	je     80106848 <deallocuvm.part.0+0x28>
    else if((*pte & PTE_P) != 0){
8010687b:	8b 10                	mov    (%eax),%edx
8010687d:	f6 c2 01             	test   $0x1,%dl
80106880:	75 1e                	jne    801068a0 <deallocuvm.part.0+0x80>
  for(; a  < oldsz; a += PGSIZE){
80106882:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106888:	39 fb                	cmp    %edi,%ebx
8010688a:	72 c8                	jb     80106854 <deallocuvm.part.0+0x34>
8010688c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
      kfree(v);
      *pte = 0;
    }
  }
...
8010688f:	8d 65 f4             	lea    -0xc(%ebp),%esp
...
801068a6:	74 26                	je     801068ce <deallocuvm.part.0+0xae>
      kfree(v);
801068a8:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
801068ab:	81 c2 00 00 00 80    	add    $0x80000000,%edx
801068b1:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
801068b4:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
801068ba:	52                   	push   %edx
801068bb:	e8 e0 bb ff ff       	call   801024a0 <kfree>
      *pte = 0;
801068c0:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(; a  < oldsz; a += PGSIZE){
801068c3:	83 c4 10             	add    $0x10,%esp
      *pte = 0;
801068c6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
801068cc:	eb 82                	jmp    80106850 <deallocuvm.part.0+0x30>
        panic("kfree");
801068ce:	83 ec 0c             	sub    $0xc,%esp
801068d1:	68 ac 73 10 80       	push   $0x801073ac
801068d6:	e8 a5 9a ff ff       	call   80100380 <panic>
...
801068f1:	89 45 e0             	mov    %eax,-0x20(%ebp)
...
80106908:	eb 3f                	jmp    80106949 <mappages+0x69>
...
8010693f:	39 c3                	cmp    %eax,%ebx
80106941:	74 6d                	je     801069b0 <mappages+0xd0>
    a += PGSIZE;
80106943:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106949:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  pde = &pgdir[PDX(va)];
8010694c:	8b 4d e0             	mov    -0x20(%ebp),%ecx
8010694f:	8d 34 03             	lea    (%ebx,%eax,1),%esi
80106952:	89 d8                	mov    %ebx,%eax
80106954:	c1 e8 16             	shr    $0x16,%eax
80106957:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
8010695a:	8b 07                	mov    (%edi),%eax
8010695c:	a8 01                	test   $0x1,%al
8010695e:	75 b0                	jne    80106910 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80106960:	e8 fb bc ff ff       	call   80102660 <kalloc>
80106965:	85 c0                	test   %eax,%eax
80106967:	74 37                	je     801069a0 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106969:	83 ec 04             	sub    $0x4,%esp
8010696c:	68 00 10 00 00       	push   $0x1000
80106971:	6a 00                	push   $0x0
80106973:	50                   	push   %eax
80106974:	89 45 d8             	mov    %eax,-0x28(%ebp)
80106977:	e8 94 dd ff ff       	call   80104710 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010697c:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010697f:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106982:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106988:	83 c8 07             	or     $0x7,%eax
8010698b:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010698d:	89 d8                	mov    %ebx,%eax
8010698f:	c1 e8 0a             	shr    $0xa,%eax
80106992:	25 fc 0f 00 00       	and    $0xffc,%eax
80106997:	01 d0                	add    %edx,%eax
80106999:	eb 90                	jmp    8010692b <mappages+0x4b>
8010699b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
}
...
801069bd:	68 e0 75 10 80       	push   $0x801075e0
...
801069d3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069d6:	e8 65 cf ff ff       	call   80103940 <cpuid>
  pd[0] = size-1;
...
801069ea:	c7 80 18 18 11 80 ff 	movl   $0xffff,-0x7feee7e8(%eax)
801069f1:	ff 00 00 
801069f4:	c7 80 1c 18 11 80 00 	movl   $0xcf9a00,-0x7feee7e4(%eax)
801069fb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
801069fe:	c7 80 20 18 11 80 ff 	movl   $0xffff,-0x7feee7e0(%eax)
80106a05:	ff 00 00 
80106a08:	c7 80 24 18 11 80 00 	movl   $0xcf9200,-0x7feee7dc(%eax)
80106a0f:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106a12:	c7 80 28 18 11 80 ff 	movl   $0xffff,-0x7feee7d8(%eax)
80106a19:	ff 00 00 
80106a1c:	c7 80 2c 18 11 80 00 	movl   $0xcffa00,-0x7feee7d4(%eax)
80106a23:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106a26:	c7 80 30 18 11 80 ff 	movl   $0xffff,-0x7feee7d0(%eax)
80106a2d:	ff 00 00 
80106a30:	c7 80 34 18 11 80 00 	movl   $0xcff200,-0x7feee7cc(%eax)
80106a37:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106a3a:	05 10 18 11 80       	add    $0x80111810,%eax
  pd[1] = (uint)p;
...
80106a50:	c9                   	leave
80106a51:	c3                   	ret
80106a52:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106a59:	00 
80106a5a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80106a60 <switchkvm>:
  lcr3(V2P(kpgdir));   // switch to the kernel page table
80106a60:	a1 c4 44 11 80       	mov    0x801144c4,%eax
...
80106a94:	0f 84 c2 00 00 00    	je     80106b5c <switchuvm+0xec>
  pushcli();
80106a9a:	e8 21 da ff ff       	call   801044c0 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a9f:	e8 3c ce ff ff       	call   801038e0 <mycpu>
80106aa4:	89 c3                	mov    %eax,%ebx
80106aa6:	e8 35 ce ff ff       	call   801038e0 <mycpu>
80106aab:	89 c7                	mov    %eax,%edi
80106aad:	e8 2e ce ff ff       	call   801038e0 <mycpu>
80106ab2:	83 c7 08             	add    $0x8,%edi
80106ab5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ab8:	e8 23 ce ff ff       	call   801038e0 <mycpu>
...
80106b9b:	77 49                	ja     80106be6 <inituvm+0x66>
  mem = kalloc();
80106b9d:	e8 be ba ff ff       	call   80102660 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106baf:	e8 5c db ff ff       	call   80104710 <memset>
...
80106bc9:	e8 12 fd ff ff       	call   801068e0 <mappages>
  memmove(mem, init, sz);
80106bce:	83 c4 10             	add    $0x10,%esp
80106bd1:	89 75 10             	mov    %esi,0x10(%ebp)
80106bd4:	89 7d 0c             	mov    %edi,0xc(%ebp)
...
80106be0:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106be1:	e9 ba db ff ff       	jmp    801047a0 <memmove>
    panic("inituvm: more than a page");
80106be6:	83 ec 0c             	sub    $0xc,%esp
80106be9:	68 25 76 10 80       	push   $0x80107625
80106bee:	e8 8d 97 ff ff       	call   80100380 <panic>
80106bf3:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106bfa:	00 
...
80106c09:	8b 75 0c             	mov    0xc(%ebp),%esi
{
80106c0c:	8b 7d 18             	mov    0x18(%ebp),%edi
  if((uint) addr % PGSIZE != 0)
80106c0f:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c15:	0f 85 a2 00 00 00    	jne    80106cbd <loaduvm+0xbd>
  for(i = 0; i < sz; i += PGSIZE){
80106c1b:	85 ff                	test   %edi,%edi
80106c1d:	74 7d                	je     80106c9c <loaduvm+0x9c>
80106c1f:	90                   	nop
  pde = &pgdir[PDX(va)];
80106c20:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80106c23:	8b 55 08             	mov    0x8(%ebp),%edx
80106c26:	01 f0                	add    %esi,%eax
  pde = &pgdir[PDX(va)];
80106c28:	89 c1                	mov    %eax,%ecx
80106c2a:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80106c2d:	8b 0c 8a             	mov    (%edx,%ecx,4),%ecx
80106c30:	f6 c1 01             	test   $0x1,%cl
80106c33:	75 13                	jne    80106c48 <loaduvm+0x48>
      panic("loaduvm: address should exist");
80106c35:	83 ec 0c             	sub    $0xc,%esp
80106c38:	68 3f 76 10 80       	push   $0x8010763f
80106c3d:	e8 3e 97 ff ff       	call   80100380 <panic>
80106c42:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106c48:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c4b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106c51:	25 fc 0f 00 00       	and    $0xffc,%eax
80106c56:	8d 8c 01 00 00 00 80 	lea    -0x80000000(%ecx,%eax,1),%ecx
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106c5d:	85 c9                	test   %ecx,%ecx
80106c5f:	74 d4                	je     80106c35 <loaduvm+0x35>
    if(sz - i < PGSIZE)
80106c61:	89 fb                	mov    %edi,%ebx
80106c63:	b8 00 10 00 00       	mov    $0x1000,%eax
80106c68:	29 f3                	sub    %esi,%ebx
80106c6a:	39 c3                	cmp    %eax,%ebx
80106c6c:	0f 47 d8             	cmova  %eax,%ebx
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c6f:	53                   	push   %ebx
80106c70:	8b 45 14             	mov    0x14(%ebp),%eax
80106c73:	01 f0                	add    %esi,%eax
80106c75:	50                   	push   %eax
    pa = PTE_ADDR(*pte);
80106c76:	8b 01                	mov    (%ecx),%eax
80106c78:	25 00 f0 ff ff       	and    $0xfffff000,%eax
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c7d:	05 00 00 00 80       	add    $0x80000000,%eax
80106c82:	50                   	push   %eax
80106c83:	ff 75 10             	push   0x10(%ebp)
80106c86:	e8 25 ae ff ff       	call   80101ab0 <readi>
80106c8b:	83 c4 10             	add    $0x10,%esp
80106c8e:	39 d8                	cmp    %ebx,%eax
80106c90:	75 1e                	jne    80106cb0 <loaduvm+0xb0>
  for(i = 0; i < sz; i += PGSIZE){
80106c92:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106c98:	39 fe                	cmp    %edi,%esi
80106c9a:	72 84                	jb     80106c20 <loaduvm+0x20>
}
80106c9c:	8d 65 f4             	lea    -0xc(%ebp),%esp
  return 0;
80106c9f:	31 c0                	xor    %eax,%eax
}
80106ca1:	5b                   	pop    %ebx
80106ca2:	5e                   	pop    %esi
80106ca3:	5f                   	pop    %edi
80106ca4:	5d                   	pop    %ebp
80106ca5:	c3                   	ret
80106ca6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106cad:	00 
...
80106cc0:	68 94 78 10 80       	push   $0x80107894
...
80106cde:	0f 88 98 00 00 00    	js     80106d7c <allocuvm+0xac>
80106ce4:	89 f2                	mov    %esi,%edx
  if(newsz < oldsz)
80106ce6:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106ce9:	0f 82 a1 00 00 00    	jb     80106d90 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106cef:	8b 45 0c             	mov    0xc(%ebp),%eax
80106cf2:	05 ff 0f 00 00       	add    $0xfff,%eax
80106cf7:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106cfc:	89 c7                	mov    %eax,%edi
  for(; a < newsz; a += PGSIZE){
80106cfe:	39 f0                	cmp    %esi,%eax
80106d00:	0f 83 8d 00 00 00    	jae    80106d93 <allocuvm+0xc3>
80106d06:	89 75 e4             	mov    %esi,-0x1c(%ebp)
80106d09:	eb 44                	jmp    80106d4f <allocuvm+0x7f>
...
80106d1b:	e8 f0 d9 ff ff       	call   80104710 <memset>
...
80106d2f:	89 fa                	mov    %edi,%edx
80106d31:	50                   	push   %eax
80106d32:	8b 45 08             	mov    0x8(%ebp),%eax
80106d35:	e8 a6 fb ff ff       	call   801068e0 <mappages>
80106d3a:	83 c4 10             	add    $0x10,%esp
80106d3d:	85 c0                	test   %eax,%eax
80106d3f:	78 5f                	js     80106da0 <allocuvm+0xd0>
  for(; a < newsz; a += PGSIZE){
80106d41:	81 c7 00 10 00 00    	add    $0x1000,%edi
80106d47:	39 f7                	cmp    %esi,%edi
80106d49:	0f 83 89 00 00 00    	jae    80106dd8 <allocuvm+0x108>
    mem = kalloc();
80106d4f:	e8 0c b9 ff ff       	call   80102660 <kalloc>
...
80106d5d:	68 5d 76 10 80       	push   $0x8010765d
80106d62:	e8 49 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106d67:	83 c4 10             	add    $0x10,%esp
80106d6a:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106d6d:	74 0d                	je     80106d7c <allocuvm+0xac>
80106d6f:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106d72:	8b 45 08             	mov    0x8(%ebp),%eax
80106d75:	89 f2                	mov    %esi,%edx
80106d77:	e8 a4 fa ff ff       	call   80106820 <deallocuvm.part.0>
    return 0;
80106d7c:	31 d2                	xor    %edx,%edx
}
...
80106d86:	5d                   	pop    %ebp
80106d87:	c3                   	ret
80106d88:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106d8f:	00 
    return oldsz;
80106d90:	8b 55 0c             	mov    0xc(%ebp),%edx
}
80106d93:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106d96:	89 d0                	mov    %edx,%eax
80106d98:	5b                   	pop    %ebx
80106d99:	5e                   	pop    %esi
80106d9a:	5f                   	pop    %edi
80106d9b:	5d                   	pop    %ebp
...
80106da3:	68 75 76 10 80       	push   $0x80107675
80106da8:	e8 03 99 ff ff       	call   801006b0 <cprintf>
  if(newsz >= oldsz)
80106dad:	83 c4 10             	add    $0x10,%esp
80106db0:	3b 75 0c             	cmp    0xc(%ebp),%esi
80106db3:	74 0d                	je     80106dc2 <allocuvm+0xf2>
80106db5:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106db8:	8b 45 08             	mov    0x8(%ebp),%eax
80106dbb:	89 f2                	mov    %esi,%edx
80106dbd:	e8 5e fa ff ff       	call   80106820 <deallocuvm.part.0>
      kfree(mem);
80106dc2:	83 ec 0c             	sub    $0xc,%esp
80106dc5:	53                   	push   %ebx
80106dc6:	e8 d5 b6 ff ff       	call   801024a0 <kfree>
      return 0;
80106dcb:	83 c4 10             	add    $0x10,%esp
    return 0;
80106dce:	31 d2                	xor    %edx,%edx
80106dd0:	eb ac                	jmp    80106d7e <allocuvm+0xae>
80106dd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
80106dd8:	8b 55 e4             	mov    -0x1c(%ebp),%edx
}
...
80106e00:	5d                   	pop    %ebp
80106e01:	e9 1a fa ff ff       	jmp    80106820 <deallocuvm.part.0>
...
80106e12:	5d                   	pop    %ebp
80106e13:	c3                   	ret
80106e14:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106e1b:	00 
...
80106e3b:	e8 e0 f9 ff ff       	call   80106820 <deallocuvm.part.0>
    panic("freevm: no pgdir");
  deallocuvm(pgdir, KERNBASE, 0);
  for(i = 0; i < NPDENTRIES; i++){
80106e40:	8d be 00 10 00 00    	lea    0x1000(%esi),%edi
80106e46:	eb 0f                	jmp    80106e57 <freevm+0x37>
80106e48:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106e4f:	00 
...
80106e6e:	e8 2d b6 ff ff       	call   801024a0 <kfree>
...
80106e83:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e84:	e9 17 b6 ff ff       	jmp    801024a0 <kfree>
    panic("freevm: no pgdir");
80106e89:	83 ec 0c             	sub    $0xc,%esp
80106e8c:	68 91 76 10 80       	push   $0x80107691
...
80106ea5:	e8 b6 b7 ff ff       	call   80102660 <kalloc>
80106eaa:	85 c0                	test   %eax,%eax
80106eac:	74 5e                	je     80106f0c <setupkvm+0x6c>
  memset(pgdir, 0, PGSIZE);
80106eae:	83 ec 04             	sub    $0x4,%esp
80106eb1:	89 c6                	mov    %eax,%esi
...
80106ec0:	e8 4b d8 ff ff       	call   80104710 <memset>
...
80106ed3:	ff 73 0c             	push   0xc(%ebx)
80106ed6:	50                   	push   %eax
80106ed7:	29 c1                	sub    %eax,%ecx
80106ed9:	89 f0                	mov    %esi,%eax
80106edb:	e8 00 fa ff ff       	call   801068e0 <mappages>
...
80106f04:	e8 17 ff ff ff       	call   80106e20 <freevm>
      return 0;
80106f09:	83 c4 10             	add    $0x10,%esp
}
80106f0c:	8d 65 f8             	lea    -0x8(%ebp),%esp
    return 0;
80106f0f:	31 f6                	xor    %esi,%esi
}
...
80106f2b:	a3 c4 44 11 80       	mov    %eax,0x801144c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80106f46:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
80106f49:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
80106f4c:	89 c1                	mov    %eax,%ecx
80106f4e:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
80106f51:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
80106f54:	f6 c2 01             	test   $0x1,%dl
80106f57:	75 17                	jne    80106f70 <clearpteu+0x30>
  pte_t *pte;
...
80106f5c:	68 a2 76 10 80       	push   $0x801076a2
...
80106f87:	74 d0                	je     80106f59 <clearpteu+0x19>
  *pte &= ~PTE_U;
80106f89:	83 20 fb             	andl   $0xfffffffb,(%eax)
}
80106f8c:	c9                   	leave
80106f8d:	c3                   	ret
...
80106f96:	83 ec 1c             	sub    $0x1c,%esp
  ...
  if((d = setupkvm()) == 0)
80106f99:	e8 02 ff ff ff       	call   80106ea0 <setupkvm>
80106f9e:	89 45 e0             	mov    %eax,-0x20(%ebp)
80106fa1:	85 c0                	test   %eax,%eax
80106fa3:	0f 84 e9 00 00 00    	je     80107092 <copyuvm+0x102>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
80106fa9:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80106fac:	85 c9                	test   %ecx,%ecx
80106fae:	0f 84 b2 00 00 00    	je     80107066 <copyuvm+0xd6>
80106fb4:	31 f6                	xor    %esi,%esi
80106fb6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80106fbd:	00 
80106fbe:	66 90                	xchg   %ax,%ax
  if(*pde & PTE_P){
80106fc0:	8b 4d 08             	mov    0x8(%ebp),%ecx
  pde = &pgdir[PDX(va)];
80106fc3:	89 f0                	mov    %esi,%eax
80106fc5:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106fc8:	8b 04 81             	mov    (%ecx,%eax,4),%eax
80106fcb:	a8 01                	test   $0x1,%al
80106fcd:	75 11                	jne    80106fe0 <copyuvm+0x50>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
80106fcf:	83 ec 0c             	sub    $0xc,%esp
80106fd2:	68 ac 76 10 80       	push   $0x801076ac
...
80106ff9:	74 d4                	je     80106fcf <copyuvm+0x3f>
    if(!(*pte & PTE_P))
80106ffb:	8b 00                	mov    (%eax),%eax
80106ffd:	a8 01                	test   $0x1,%al
80106fff:	0f 84 9f 00 00 00    	je     801070a4 <copyuvm+0x114>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80107005:	89 c7                	mov    %eax,%edi
    flags = PTE_FLAGS(*pte);
80107007:	25 ff 0f 00 00       	and    $0xfff,%eax
8010700c:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    pa = PTE_ADDR(*pte);
8010700f:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    if((mem = kalloc()) == 0)
80107015:	e8 46 b6 ff ff       	call   80102660 <kalloc>
8010701a:	89 c3                	mov    %eax,%ebx
8010701c:	85 c0                	test   %eax,%eax
8010701e:	74 64                	je     80107084 <copyuvm+0xf4>
      goto bad;
...
80107066:	8b 45 e0             	mov    -0x20(%ebp),%eax
...
8010707c:	e8 1f b4 ff ff       	call   801024a0 <kfree>
      goto bad;
80107081:	83 c4 10             	add    $0x10,%esp
  freevm(d);
80107084:	83 ec 0c             	sub    $0xc,%esp
80107087:	ff 75 e0             	push   -0x20(%ebp)
8010708a:	e8 91 fd ff ff       	call   80106e20 <freevm>
  return 0;
8010708f:	83 c4 10             	add    $0x10,%esp
    return 0;
80107092:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
}
...
801070a7:	68 c6 76 10 80       	push   $0x801076c6
801070ac:	e8 cf 92 ff ff       	call   80100380 <panic>
801070b1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801070b8:	00 
...
801070c3:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(*pde & PTE_P){
801070c6:	8b 55 08             	mov    0x8(%ebp),%edx
  pde = &pgdir[PDX(va)];
801070c9:	89 c1                	mov    %eax,%ecx
801070cb:	c1 e9 16             	shr    $0x16,%ecx
  if(*pde & PTE_P){
801070ce:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801070d1:	f6 c2 01             	test   $0x1,%dl
801070d4:	0f 84 f8 00 00 00    	je     801071d2 <uva2ka.cold>
  return &pgtab[PTX(va)];
801070da:	c1 e8 0c             	shr    $0xc,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
801070dd:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  if((*pte & PTE_P) == 0)
    return 0;
  if((*pte & PTE_U) == 0)
    return 0;
...
801070e3:	5d                   	pop    %ebp
  return &pgtab[PTX(va)];
801070e4:	25 ff 03 00 00       	and    $0x3ff,%eax
  if((*pte & PTE_P) == 0)
801070e9:	8b 94 82 00 00 00 80 	mov    -0x80000000(%edx,%eax,4),%edx
  return (char*)P2V(PTE_ADDR(*pte));
801070f0:	89 d0                	mov    %edx,%eax
801070f2:	f7 d2                	not    %edx
801070f4:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801070f9:	05 00 00 00 80       	add    $0x80000000,%eax
801070fe:	83 e2 05             	and    $0x5,%edx
80107101:	ba 00 00 00 00       	mov    $0x0,%edx
...
8010711c:	8b 45 0c             	mov    0xc(%ebp),%eax
8010711f:	8b 55 10             	mov    0x10(%ebp),%edx
  char *buf, *pa0;
  uint n, va0;

  buf = (char*)p;
  while(len > 0){
80107122:	85 f6                	test   %esi,%esi
80107124:	75 51                	jne    80107177 <copyout+0x67>
80107126:	e9 9d 00 00 00       	jmp    801071c8 <copyout+0xb8>
8010712b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
  return (char*)P2V(PTE_ADDR(*pte));
80107130:	81 e3 00 f0 ff ff    	and    $0xfffff000,%ebx
80107136:	8d 8b 00 00 00 80    	lea    -0x80000000(%ebx),%ecx
    va0 = (uint)PGROUNDDOWN(va);
    pa0 = uva2ka(pgdir, (char*)va0);
    if(pa0 == 0)
8010713c:	81 fb 00 00 00 80    	cmp    $0x80000000,%ebx
80107142:	74 74                	je     801071b8 <copyout+0xa8>
      return -1;
    n = PGSIZE - (va - va0);
80107144:	89 fb                	mov    %edi,%ebx
80107146:	29 c3                	sub    %eax,%ebx
80107148:	81 c3 00 10 00 00    	add    $0x1000,%ebx
    if(n > len)
8010714e:	39 f3                	cmp    %esi,%ebx
80107150:	0f 47 de             	cmova  %esi,%ebx
      n = len;
    memmove(pa0 + (va - va0), buf, n);
80107153:	29 f8                	sub    %edi,%eax
80107155:	83 ec 04             	sub    $0x4,%esp
80107158:	01 c1                	add    %eax,%ecx
8010715a:	53                   	push   %ebx
8010715b:	52                   	push   %edx
8010715c:	89 55 10             	mov    %edx,0x10(%ebp)
8010715f:	51                   	push   %ecx
80107160:	e8 3b d6 ff ff       	call   801047a0 <memmove>
    len -= n;
    buf += n;
80107165:	8b 55 10             	mov    0x10(%ebp),%edx
    va = va0 + PGSIZE;
80107168:	8d 87 00 10 00 00    	lea    0x1000(%edi),%eax
  while(len > 0){
8010716e:	83 c4 10             	add    $0x10,%esp
    buf += n;
80107171:	01 da                	add    %ebx,%edx
  while(len > 0){
80107173:	29 de                	sub    %ebx,%esi
80107175:	74 51                	je     801071c8 <copyout+0xb8>
  if(*pde & PTE_P){
80107177:	8b 5d 08             	mov    0x8(%ebp),%ebx
  pde = &pgdir[PDX(va)];
8010717a:	89 c1                	mov    %eax,%ecx
    va0 = (uint)PGROUNDDOWN(va);
8010717c:	89 c7                	mov    %eax,%edi
  pde = &pgdir[PDX(va)];
8010717e:	c1 e9 16             	shr    $0x16,%ecx
    va0 = (uint)PGROUNDDOWN(va);
80107181:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
  if(*pde & PTE_P){
80107187:	8b 0c 8b             	mov    (%ebx,%ecx,4),%ecx
8010718a:	f6 c1 01             	test   $0x1,%cl
8010718d:	0f 84 46 00 00 00    	je     801071d9 <copyout.cold>
  return &pgtab[PTX(va)];
80107193:	89 fb                	mov    %edi,%ebx
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80107195:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
8010719b:	c1 eb 0c             	shr    $0xc,%ebx
8010719e:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  if((*pte & PTE_P) == 0)
801071a4:	8b 9c 99 00 00 00 80 	mov    -0x80000000(%ecx,%ebx,4),%ebx
  if((*pte & PTE_U) == 0)
801071ab:	89 d9                	mov    %ebx,%ecx
801071ad:	f7 d1                	not    %ecx
801071af:	83 e1 05             	and    $0x5,%ecx
801071b2:	0f 84 78 ff ff ff    	je     80107130 <copyout+0x20>
  }
  return 0;
}
...
801071d2 <uva2ka.cold>:
  if((*pte & PTE_P) == 0)
801071d2:	a1 00 00 00 00       	mov    0x0,%eax
801071d7:	0f 0b                	ud2

801071d9 <copyout.cold>:
801071d9:	a1 00 00 00 00       	mov    0x0,%eax
801071de:	0f 0b                	ud2
